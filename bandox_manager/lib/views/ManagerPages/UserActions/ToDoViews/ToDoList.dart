...
class ToDoListOfDepartment extends StatefulWidget {
  final Departments department;
  final int state;

  const ToDoListOfDepartment(this.department, {super.key, required this.state});

  @override
  State<ToDoListOfDepartment> createState() => _ToDoListOfDepartmentState();
}

class _ToDoListOfDepartmentState extends State<ToDoListOfDepartment>
            ...
            child: BlocBuilder<ToDoListCubit, List<ToDo>>(
              builder: (context, jobList) {
                return Padding(
                  ...
                  child: Card(
                    elevation: 7.7,
                    color: Colors.blue.shade900.withValues(alpha: 1.3),
                    child: Column(
