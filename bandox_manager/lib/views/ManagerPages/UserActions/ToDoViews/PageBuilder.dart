...
import 'package:dep_manager_panel/views/ManagerPages/UserActions/UsersViews/UsersListPage.dart';
...
class PageBuilder extends StatefulWidget {
  ...
  const PageBuilder({super.key, required this.department});
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              UsersListPage(widget.department)));
                },
